    ...
    <div class="flex md:flex-row flex-col items-center justify-center mt-10 gap-4 md:gap-8 px-32">
        ...
        <div class="flex flex-row items-center justify-start mt-6">
          <div class="flex flex-row items-start justify-center">
            <h3 class="text-4xl text-[#0F1829]">$5</h3>
          </div>
        ...
        <button class="text-[#0F1829] text-lg px-4 py-2 rounded mt-2 border border-[#0F1829] block w-64">Read More</button>
        ...
        <div class="items-center border-2 bg-[#0F1829] rounded-xl px-8 py-6">
          ...
          <button class="text-[#ffffff] text-lg px-4 py-2 rounded mt-2 border border-[#ffffff] block w-64">Read More</button>
