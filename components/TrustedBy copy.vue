...
<template>
  ...
  <div class="flex flex-col items-center justify-center w-full h-44">
    <div class="relative w-full overflow-hidden">
      ...
      <button @click="prev"
        class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white text-black p-2 rounded-full shadow-md">‹</button>
      <button @click="next"
        class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white text-black p-2 rounded-full shadow-md">›</button>
    </div>
  </div>
</template>
