        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          <div class="flex flex-col items-center justify-between lg:-mr-36 md:-20">
            <div class="flex flex-row items-center justify-center">
              ...
              <img src="assets/svg/outstanding-finances.svg" alt="Line" class="w-24"/>
            </div>
            <div class="flex flex-row items-center justify-center">
              <h3 class="text-lg font-bold text-gray-800 w-52 text-end">Tax record</h3>
                <img src="assets/svg/tax-record-icon.svg" alt="Line" class="w-24"/>
            </div>
            <div class="flex flex-row items-center justify-center">
              <h3 class="text-lg font-bold text-gray-800 w-52 text-end">Engine & consumption</h3>
                <img src="assets/svg/consumption.svg" alt="Line" class="w-24"/>
            </div>
            <div class="flex flex-row items-center justify-center">
                <h3 class="text-lg font-bold text-gray-800 w-52 text-end ">Co2 Emissions</h3>
                <img src="assets/svg/emission.svg" alt="Line" class="w-24"/>
                <img src="assets/svg/line-info-1.svg" alt="Line" class="w-32 absolute md:-mr-96 md:-mt-5 md:block hidden"/>
            </div>
            <div class="flex flex-row items-center justify-center">
              <h3 class="text-lg font-bold text-gray-800 w-52 text-end">Insurance Status</h3>
                <img src="assets/svg/ni-status.svg" alt="Line" class="w-24"/>
                <img src="assets/svg/line-info-2.svg" alt="Line" class="md:w-32 absolute md:-mr-96 md:-mt-16 md:block hidden"/>
            </div>
            <div class="flex flex-row items-center justify-center">
          ...
          <div class="flex flex-col items-center justify-between">
            ...
            <div class="flex flex-row items-center justify-center">
              <img src="assets/svg/Mot-history.svg" alt="Line" class="w-24"/>
              <h3 class="text-lg font-bold text-gray-800 w-52 text-start ">MOT History</h3>
            </div>
            <div class="flex flex-row items-center justify-center">
              <img src="assets/svg/damage-history-1.svg" alt="Line" class="w-24"/>
              <h3 class="text-lg font-bold text-gray-800 w-52 text-start">Damage History</h3>
            </div>
            <div class="flex flex-row items-center justify-center">
              <img src="assets/svg/theft-check-1.svg" alt="Line" class="w-24"/>
