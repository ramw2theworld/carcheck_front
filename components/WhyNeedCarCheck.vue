  ...
  <div class="flex items-center justify-center flex-col md:flex-row py-10">
    <div class="flex flex-row">
      ...
      <div class="flex flex-col w-72">
        ...
        <p class="md:text-lg text-sm">Check the wanted vehicle’s history to avoid bad surprises.</p>
        <p class="text-[#FF7400] text-xs md:text-sm">5% of sold cars were reported stolen</p>
        <p class="text-[#FF7400] text-xs md:text-sm">17% of sold cars were clocked</p>
        <p class="text-[#FF7400] text-xs md:text-sm">18% had outstanding finances</p>
      </div>
    </div>
    <div class="flex flex-row">
      ...
      <div class="flex flex-col  w-72">
        ...
        <p class="md:text-lg text-sm">Use our data to reassure buyers about history & market value</p>
